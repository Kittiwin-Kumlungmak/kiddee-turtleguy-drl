...
from .settings import ENABLE_BACKWARD, ENABLE_STACKING, ACTION_SIZE, HIDDEN_SIZE, BATCH_SIZE, BUFFER_SIZE, DISCOUNT_FACTOR, \
...
class OffPolicyAgent(ABC):
    def __init__(self, device, simulation_speed):
        ...
        # Network structure
        self.state_size         = util.get_scan_count() + 4
